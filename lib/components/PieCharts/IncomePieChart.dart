...
class IncomePieChart extends StatelessWidget {
  ...
  IncomePieChart({required this.paymentMethod});
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder(
      ...
      builder: (context, snapshot) {
        ...
        double total = incomeMap.values.fold(0, (sum, val) => sum + val);
        ...
        incomeMap.forEach((key, value) {
          ...
          data.add(PieChartSectionData(
            ...
            color: CategoryColors.incomeColors[colorIndex % CategoryColors.incomeColors.length],
            radius: 100,
          ));
          legend.add({
            "label": key,
